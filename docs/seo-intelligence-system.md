...
- Control de despliegues añadido tras detectar el límite de créditos de Netlify: cada 15 minutos compara cinco archivos críticos del contenedor desplegado con su respuesta pública y abre una P1 solo después de dos diferencias consecutivas.
